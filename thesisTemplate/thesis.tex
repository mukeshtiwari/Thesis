...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Preamble
\title{Formally Verified Verifiable Electronic Voting Scheme}
...
%% Chapters
\input{background}
\input{theorem_crypto}
\input{schulze_evidence}
\input{homomorphic_schulze}
\input{software_independence}
\input{machine_checked}
\input{conclusion}
