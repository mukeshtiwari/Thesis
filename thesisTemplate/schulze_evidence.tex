...
beaten by any (other) candidate.
	...
	\subsection{An Example}
	 ...
	 The graph below shows that collective can be cyclic, even if the preferences of individual voters are not cyclic (Condercet paradox).
\[
...
\item Privacy : There is no privacy  because the ballots involved 
         are simply plaintext, and potentially, it could lead coercion and vote-selling.
\end{itemize}
\end{itemize}
