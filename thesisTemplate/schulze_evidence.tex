...
\subfigure[Direct Extraction]{\label{fig:straight}\includegraphics[width=60mm]{1.png}}
\subfigure[Extraction using Haskell Integers]{\label{fig:native}\includegraphics[width=60mm]{2.png}}
\caption{Experimental Results}
\label{fig:test}
\end{figure}
...
\begin{figure}
\centering     %%% not \center
\subfigure[Computation of Winners]{\label{fig:straight}\includegraphics[width=60mm]{without-cert.png}}
\subfigure[Computation of Winners and Certificate]{\label{fig:native}\includegraphics[width=60mm]{with-cert.png}}
\caption{Experimental Results}
\label{fig:test}
\end{figure}
...
In this chapter,  we emphasize on correctness, and we take the approach that 
...
Our formalization focuses on \textit{Correctness}, \textit{Practicality}, and 
\textit{Verifiability}. There are some wrinkles in this formalization. One major is 
...
\item Verifiability:  Certificates generated for plaintext ballot 
		 during the election 
