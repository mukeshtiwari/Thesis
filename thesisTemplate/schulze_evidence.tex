...
\section{Introduction}
 In the chapter \ref{cha:background},  we have already discussed the 
 high level picture of correctness, verifiability 
...
but useless for machine because it is in \texttt{Prop}; on the other hand, 
\texttt{wins\_type} which is useful for the machine because it is in \texttt{Type}, but 
not so useful for human. We formally establish that type level winning and prop level winning 
...
\noindent
It is precisely this additional data or scrutiny sheet  (on top of merely declaring a set of
...
numbers. The results are displayed in Figure \ref{fig:straightslow}
