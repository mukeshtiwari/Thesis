...
definition, to verify the validity of a ballot, is that if we decrypt 
the ballot $eballot$ to get the plaintext ballot $pballot$ to evidence the validity,   
...
However, we cannot publish the $ptballot$ as an evidence of validity of 
...
\begin{itemize}
  \item generating a secret permutation, $\pi$, and publishing its commitment.
...
\item publishes the winner(s), together with evidence to substantiate the claim (existence of strongest path the winner to the loser 
