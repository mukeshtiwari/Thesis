...
formally verified certificate checker for the International Association of Cryptographic Research 2018 election
...
\section{Related Work}
 ...
 addresses the different issues related of electronic voting protocols  in symbolic model (pi-calculus  
 ...
 and verify its correctness properties.  Pi-calculus, a a formalism for describing concurrent systems,
 ...
 and automatically verifying  its security properties using pi-calculus has been 
 ...
 Similarly, \citep{10.1007/978-3-642-28641-4_7} have used pi-calculus to ascertain the properties of 
 Norwegian electronic voting protocol. 
 Receipt-freeness and vote-privacy of Selene voting protocol \citep{Selene} have been 
 proved by \citep{10.1007/978-3-319-68687-5_7}  using the Tamarin \citep{10.5555/2958031.2958047}.
 Most of these work differs from ours
 ...
 \noindent
 Linear logic \citep{GIRARD19871} has been used by \citep{DeYoung:2012:LLV} to model the different entity in electronic voting as a resource. 
 ...
 need to show her photo id to multiple times at counting booth. Mathematical proof theory has 
 ...
 or audit the outcome of election result.  In further research, \citep{10.1007/978-3-030-03592-1_5} 
 ...
 However, none of these work considers privacy and coercion resistance as a key 
 ...
 a particular voter if the number of candidates participating in election are large. Suppose
 if there are 40 candidates are participating in a election, then there are \textit{40!
 ...
 fill her ballot. Since the number of options are very large, if a candidate and a voter want 
