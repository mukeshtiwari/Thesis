...
The Coq proof assistant  is interactive theorem prover based on underlying theory of Calculus of 
Inductive Construction [Cite Pualine Mohring]  which itself is a augmentation of Calculus of Construction 
[cite Huet and Coquand] with inductive data-type.  Coq provides a highly expressive specification 
 language Gallina for development of mathematical theories and proving the theorems about these
 ...
 tactics to build the  Gallina term  which otherwise would  be very laborious.  In this chapter, I will give a 
...
\section{Theoretical Foundation of Coq}
\label{sec:thesisstatement}
Calculus of Construction is \fix {write here Coc + CIC and typing inference}.



\section{Coq in Action (Example)}
