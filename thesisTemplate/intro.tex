...
We answer these question by taking \textbf{Schulze}\cite{Schulze:2011:NMC} 
algorithm as an example and \textbf{Coq} \citep{Bertot:2004:ITP}
...
\begin{enumerate}
 ...
 \item \texttt{Verifiability} by tabulating the relevant data of election. We call it scrutiny-sheet/certificate. 
   ...
   the same with a encrypted ballot counting.  To achieve verifiability in encrypted ballot counting, 
...
facilitator to achieve our goals of privacy and verifiability in electronic voting. We have 
assumed the existence of cryptographic primitives inside Coq theorem prover with the 
...
with some external library function.  We will discuss more on this in chapter 4 (Homomorphic 
Schulze Algorithm: Axiomatic Approach).

Formalizing the whole cryptographic stack used in our 
