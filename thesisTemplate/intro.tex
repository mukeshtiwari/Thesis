...
\section{Related Work}
 ...
 or audit the outcome of election result.  Upon further investigation, \citep{10.1007/978-3-030-03592-1_5} 
 developed a formally verified certificate checker by using the theorem prover HOL4 \citep{Slind:2008:BOH:1459784.1459792}. 
 Moreover, they connected the HOL4 proofs to the formally verified compiler CakeML \citep{Kumar:2014:CVI} 
 to get a executable which was correctly with respect to the formal specification of the protocol down to machine level. 
