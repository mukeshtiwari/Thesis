...
(ii) a tool to implement the voting protocol which can also provide the "guaranteed" correctness.
...
The Coq theorem prover is a highly expressive theorem prover because of 
dependent types (Section \ref{sec:deplambda}). Moreover, during the proof development, 
