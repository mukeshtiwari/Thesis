...
After inspecting the current state of art in electronic voting, we 
 ...
 In order to answer these two questions, we needed two things: i) A voting protocol and ii): A theorem 
 prover. For voting protocol, we settled down with \cite{Schulze:2011:NMC},  and for theorem prover, our preference 
 was \cite{Bertot:2004:ITP}. Even though Schulze method is not used in any democratic election, the reason 
...
\ref{cha:schulze_method}, and about its properties in \ref{cha:machine_checked}. The 
