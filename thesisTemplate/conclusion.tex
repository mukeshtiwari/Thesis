...
process transparent and trustworthy. The current state of 
...
mathematical logic.  Rather than implementing the Schulze method, 
we gave a specification of the Schulze winning condition and losing 
...
of voting protocol (Schulze method) in the framework developed by Kenneth Arrow 
...
crucial phase of election, the correctness of counting software 
