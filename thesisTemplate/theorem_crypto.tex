...
data structures efficiently in the Coq. The keyword to declare a inductive data type in Coq is 
...
\noindent 
Now we can define various function for the \textit{Vector} data structure. For example, 
we can define a function to append two vectors for length $n$ and $p$ as follows:
