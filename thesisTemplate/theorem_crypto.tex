...
\label{sec:cryptography}
 ...
 A encryption scheme is homomorphic if for any two plaintext $x$ and $y$:
     ...
     \label{sec:zkp}
      ...
      the system. For example, we want to prove that  for any group G with group operation *, for any two elements x y $\in$ G, we have:
      \begin{displayquote}
      ...
      \noindent
      Proof: we assume arbitrary x, y. We show that $(x * y)}$ and $y^{-1} * x^{-1}$ are 
