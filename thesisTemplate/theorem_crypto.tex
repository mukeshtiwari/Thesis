...
\section{Cryptography}
   ...
   \begin{itemize}
    ...
    \subsection{Homomorphic Encryption}
     ...
     If a verifier wants to verify our proof, then he would simply check that if the rules are applied correctly. Moreover, these proofs 
     are static in nature, i.e. once the prover has produced the proof, then the content of proof is not going to change. Moreover,
    ...
    \subsubsection{Zero Knowledge Proof of Knowledge}
     ...
     Sigma protocols are efficient way to achieve zero-knowledge-proof of a knowledge. 
