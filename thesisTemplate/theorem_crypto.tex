...
different variant of lambda calculus starting from 
...
Lambda calculus was invented by Alonzo Church in the 1930, 
...
\noindent 
The typing judgement for \textit{PTS} is defined by following rules:
 \begin{itemize}
 \item Axiom: $\vdash \text{c : s} $ 
...
We would later instantiate these 
parameters to a specific value to get the instance of Calculus of Construction. 
...
for constructive proofs where every proof a typed $\lambda$-abstractions.  Its syntax 
is defined as (a simplified version):
