...
%   the security measure of iPhone which would wipe all the data. 
   ...
   to some external companies. These companies do not follow the rigours 
...
%	\subsubsection{Formally Verified Software}
	...
	from verified C compilers CompCert \citep{DBLP:conf/popl/Leroy0}, verified ML compiler
	...
	Algebra \citep{10.1007/3-540-45842-5_7}, and Kepler Conjecture \citep{hales-keple}.
